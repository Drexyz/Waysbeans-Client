      ...
      {!state.isLogin ? (
        ...
        <span className={styles.buttons}>
          <NavDropdown
            id="dropdown-basic"
            title={
              <img className={styles.avatar} src={state.user.photo} alt="avatar" />
            }
          >
            <Link
            ...
            <Dropdown.Divider />
            <Dropdown.Item className={styles.dropdownItem} href="#" onClick={logout} style={{padding: 0}}>
              <img
        ...
        <span className={styles.buttons}>
          ...
          >
          <Link
            className={styles.dropdownItem} to="/profile" style={{ textDecoration: "none" }}
          >
              <img src="./images/user.png" className={styles.dropdownPict} alt="profile"/>
              <span className={styles.dropdownText}>Profile</span>
          </Link>
          <Dropdown.Divider />
          <Dropdown.Item className={styles.dropdownItem} href="#" onClick={logout} style={{padding: 0}}>
            <img src="./images/logout.png" className={styles.dropdownPict} alt="logout" />
            <span className={styles.dropdownText}>Logout</span>
          </Dropdown.Item>
          </NavDropdown>
        </span>
